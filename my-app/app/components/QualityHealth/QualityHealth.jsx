...
import "./QualityHealth.scss"

const QualityHealth = () => {
    return (
        <section className="QualityHealth-section">
           <div className="QualityHealth-text">
                <h1 className="QualityHealth-title1">The Future</h1>
                <h1 className="QualityHealth-title2">of <span>Quality Health</span></h1>
